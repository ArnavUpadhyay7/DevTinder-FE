...
const TextInputSignUp = () => {
  ...
  return (
    ...
    <path
      ...
      <label className="input input-bordered flex items-center gap-2">
        <img className='size-5 items-start' src="https://cdn-icons-png.flaticon.com/128/483/483921.png" alt="About Icon" />
        <input type="text" placeholder='First Name' value={firstName} onChange={(e)=>{setFirstName(e.target.value)}}/>
      </label>

      <label className="input input-bordered flex items-center gap-2">
        <img className='size-5 items-start' src="https://cdn-icons-png.flaticon.com/128/6089/6089035.png" alt="About Icon" />
      ...
      <div className='flex justify-center rounded-lg bg-blue-600 hover:bg-blue-800 text-white font-semibold'>
        <button onClick={handleSignUp} className='text-base px-6 py-2'> Submit </button>
      </div>
    </div>
  )
}
